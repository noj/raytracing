...
inline vec3 cross(const vec3 &v1, const vec3 &v2) {
  return vec3(v1[1] * v2[2] - v1[2] * v2[1], -(v1[0] * v2[2] - v1[2] * v2[0]),
              v1[0] * v2[1] - v1[1] * v2[0]);
}
...
struct hittable_list : public hittable {
  ...
  explicit hittable_list(const std::vector<const hittable *> &l) : list(l) {}
...
int main() {
  ...
  const std::vector<sphere> spheres = {sphere(vec3(0, 0, -1), 0.5),
